function [symGauss_illPSF_I,illPSF_Ix0,illPSF_in_BFP,amp_in_BFP,phase_in_BFP,cy,cy_pad,cz,num_par,phys_par,illPSF] = simulatebeam(aptype, phasetype,  NA, sym,lambda,ref_index, excitation,varargin)
...
[illPSF_in_BFP,amp_in_BFP,phase_in_BFP] = compute_E_in_bfp( ...
    illPSF, num_par, phys_par, ky, kz, kr, kx);
end
